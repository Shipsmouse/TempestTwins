...
//set the return URL
$return_url = "../squeak2.php";

//set the users email address
$email = "mice@mindless.com";

//array of fields in form. (In the format "field_name" => "field_label")
$form_fields = array(
"element0" => 'Your Character Name:',
"element1" => 'Your Email:',
"element2" => 'Please re-type your email address:',
"element3" => 'Page or Subject:',
"element4" => 'Message:'
);
...
$message_success = '</br><h2>Thank you very much for sending me an email.</h2><br /><br />I will read it as soon as I logon next.  This website is updated once a week so you may not see your entry straight away.  But I will reply to your email within 48 hours and if you have not received conformation, please contact me again.<br /><br />If your message is directed to Justin Somper, I will copy a reply also to The Captain, but the email usually takes a while to reach Justin Somper.<br /><br />Regards<br />Fred the Ship\'s Mouse.<br /><br /><p style="text-align:center;"><img class="imageStyle" alt="ship" src="files/ship.jpg" width="40" height="40" /><img class="imageStyle" alt="dagger" src="files/dagger.jpg" width="40" height="40" /><img class="imageStyle" alt="jolly roger" src="files/jollyroger.jpg" width="40" height="39" /><img class="imageStyle" alt="treasure" src="files/treasure.jpg" width="40" height="40" /><img class="imageStyle" alt="ring" src="files/ring.jpg" width="40" height="40" /><img class="imageStyle" alt="books" src="files/books.jpg" width="42" height="40" /><img class="imageStyle" alt="vampirates" src="files/vampirates.jpg" width="40" height="40" /><img class="imageStyle" alt="chest" src="files/chest.jpg" width="40" height="40" /><img class="imageStyle" alt="rackham" src="files/rackham.jpg" width="40" height="39" /><img class="imageStyle" alt="right" src="files/right.jpg" width="40" height="40" /><img class="imageStyle" alt="wheel" src="files/wheel.jpg" width="40" height="40" /><br /><img class="imageStyle" alt="mouse" src="files/mouse.jpg" width="41" height="41" /></br></br></p>';
